$(document).ready(function(){
	...
	$("#btn-simpan").click(function(){ // Ketika tombol simpan di klik
		...
		data.append('no_ktp', $("#no_ktp").val()); // Ambil data nis
		data.append('nama_anggota', $("#nama_anggota").val()); // Ambil data nama
		data.append('jenis_kel', $("#jenis_kel").val()); // Ambil data jenis kelamin
		data.append('tgl_lahir', $("#tgl_lahir").val()); // Ambil data telepon
	...
	$("#btn-hapus").click(function(){ // Ketika tombol hapus di klik
		// Buat variabel data untuk menampung data hasil input dari form
		var data = new FormData();
		data.append('no_ktp', $("#data-no_ktp").val()); // Ambil data nis
