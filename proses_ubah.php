...
if(isset($_POST['ubah_foto'])){ // Jika user menceklis checkbox yang ada di form ubah, lakukan :
	...
	if(move_uploaded_file($tmp, $path)){ // Jika proses upload sukses
		...
		$sql = $pdo->prepare("UPDATE anggota SET nama_anggota=:nama_anggota, jenis_kel=:jenis_kel, tgl_lahir=:tgl_lahir, foto=:foto, alamat=:alamat WHERE no_ktp=:no_ktp");
	...
	// Proses ubah ke Database
	$sql = $pdo->prepare("UPDATE anggota SET nama_anggota=:nama_anggota, jenis_kel=:jenis_kel, tgl_lahir=:tgl_lahir, alamat=:alamat WHERE no_ktp=:no_ktp");
	$sql->bindParam(':nama_anggota', $nama_anggota);
	$sql->bindParam(':jenis_kel', $jenis_kel);
	$sql->bindParam(':tgl_lahir', $tgl_lahir);
	$sql->bindParam(':alamat', $alamat);
